        ...
        btSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!etCodigoDeBarras.getText().toString().isEmpty() &&
                    ...
                    Snackbar.make(findViewById(R.id.container_activity_produtoadmin), "Preencha todos os campos", Snackbar.LENGTH_LONG).show();
                }
    ...
    private void uploadFotoDoProduto() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(ProdutoAdminActivity.this, "Falha ao enviar o arquivo", Toast.LENGTH_SHORT).show();
            }
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.getValue() != null){
                        Toast.makeText(ProdutoAdminActivity.this, "Código de barras já cadastrado", Toast.LENGTH_SHORT).show();
                    }else{
                        showWait();
                        DatabaseReference myRef = database.getReference("vendas/produtos");
                        ...
                        myRef.child(produto.getKey()).setValue(produto) //salva o produto no database
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(ProdutoAdminActivity.this, "Produto salvo!", Toast.LENGTH_SHORT).show();
                                        limparForm();
                                        dismissWait();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Snackbar.make(findViewById(R.id.container_activity_produtoadmin), "Operação falhou", Snackbar.LENGTH_LONG).show();
                                        dismissWait();
                                    }
                                });
                    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getValue() != null){
                    ...
                    Toast.makeText(ProdutoAdminActivity.this, "Produto não cadastrado", Toast.LENGTH_SHORT).show();
                }
            }
